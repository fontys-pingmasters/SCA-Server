        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Opponent1Id = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Matches_Users_Opponent1Id",
                        column: x => x.Opponent1Id,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Matches_Users_Opponent2Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompetitionMemberships", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CompetitionMemberships_Competitions_CompetitionId",
                        column: x => x.CompetitionId,
                        principalTable: "Competitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompetitionMemberships_Teams_TeamId",
                        column: x => x.TeamId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompetitionMatches_Matches_MatchId",
                        column: x => x.MatchId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MatchRequests_Users_ReceiverId",
                        column: x => x.ReceiverId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MatchRequests_Users_SenderId",
                        column: x => x.SenderId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompetitionMatches_MatchId",
                table: "CompetitionMatches",
                column: "MatchId");

            migrationBuilder.CreateIndex(
                name: "IX_CompetitionMemberships_CompetitionId",
                table: "CompetitionMemberships",
                column: "CompetitionId");

            migrationBuilder.CreateIndex(
                name: "IX_CompetitionMemberships_TeamId",
                table: "CompetitionMemberships",
                column: "TeamId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Matches_Opponent1Id",
                table: "Matches",
                column: "Opponent1Id");

            migrationBuilder.CreateIndex(
                name: "IX_Matches_Opponent2Id",
                table: "Matches",
                column: "Opponent2Id");
